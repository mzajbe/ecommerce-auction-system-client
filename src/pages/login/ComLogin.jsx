          ...
          <div className="form-container w-full">
            ...
            >
              <div className="login-title text-center">
                ...
                <p className="text-2xl py-5">Hey, Enter Your Company Credential <br />for Sign in</p>
              </div>
              {/* name inout field  */}
              <div className="">
                <input
                  ...
                  name="car_name"
                  id="car_name"
                  className="mt-2 py-4 px-6 block mt-0 w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 text-xl border-2"
              ...
              <div className="regAndforget text-lg py-5 flex justify-between">
                ...
                <span className="">Don&apos;t have an account yet? </span><Link className="text-blue-600 font-bold" to="/comRegistration">Register Now!</Link>
                </div>
