...
const DemoAuctionPage = () => {
  ...
  const placeBid = () => {
    ...
    if (bidAmount > selectedAuction.currentBid) {
      const updatedAuctions = auctions.map((auction) =>
        auction.id === selectedAuction.id
          ? {
              ...
              bids: [
                ...auction.bids,
                { user: "current_user", amount: bidAmount },
              ],
            }
          : auction
      );
      ...
      setSelectedAuction(
        updatedAuctions.find((a) => a.id === selectedAuction.id)
      );
      setNewBid("");
    } else {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="w-64 bg-white shadow-md p-4 space-y-4">
        <h2 className="text-2xl font-bold text-gray-800 mb-4 mt-20">
          Active Auctions
        </h2>
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 mt-10">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              <div>
                ...
                <p>
                  {Math.round(
                    (selectedAuction.endTime - new Date()) / (1000 * 60 * 60)
                  )}{" "}
                  hours
                </p>
              </div>
